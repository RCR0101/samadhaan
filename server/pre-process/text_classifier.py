...
def main():
    ...
    model = BertForSequenceClassification.from_pretrained('bert-base-multilingual-cased', num_labels=500).to(DEVICE)

    train_dataset = TextDataset(f'output_csv/updated_post_csv-small-int-1.csv', tokenizer)
